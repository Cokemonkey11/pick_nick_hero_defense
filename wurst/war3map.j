...
globals
    ...
    trigger                 gg_trg_PICNIC              = null
    trigger                 gg_trg_Toilet_flush        = null
    unit                    gg_unit_eshd_0000          = null
    unit                    gg_unit_Efur_0001          = null
    unit                    gg_unit_nwat_0002          = null
    unit                    gg_unit_Etyr_0003          = null
    unit                    gg_unit_Eill_0004          = null
    unit                    gg_unit_edry_0005          = null
    unit                    gg_unit_Ekgg_0007          = null
    unit                    gg_unit_ewsp_0008          = null
    unit                    gg_unit_edtm_0009          = null
    unit                    gg_unit_emow_0010          = null
endglobals
...
function CreateBuildingsForPlayer0 takes nothing returns nothing
    ...
    set gg_unit_emow_0010 = CreateUnit( p, 'emow', -2336.0, 2720.0, 270.000 )
...
function CreateUnitsForPlayer1 takes nothing returns nothing
    ...
    set gg_unit_Eill_0004 = CreateUnit( p, 'Eill', -2267.5, 1727.8, 23.680 )
    call SetHeroLevel( gg_unit_Eill_0004, 7, false )
    call SelectHeroSkill( gg_unit_Eill_0004, 'AEme' )
endfunction
...
function CreateUnitsForPlayer2 takes nothing returns nothing
    ...
    set gg_unit_nwat_0002 = CreateUnit( p, 'nwat', -2042.5, 2273.3, 191.160 )
endfunction
...
function CreateUnitsForPlayer3 takes nothing returns nothing
    ...
    set gg_unit_Efur_0001 = CreateUnit( p, 'Efur', -2490.4, 2339.6, 340.160 )
    call SetHeroLevel( gg_unit_Efur_0001, 7, false )
    call SelectHeroSkill( gg_unit_Efur_0001, 'AEer' )
    call SelectHeroSkill( gg_unit_Efur_0001, 'AEer' )
    call SelectHeroSkill( gg_unit_Efur_0001, 'AEtq' )
endfunction
...
function CreateUnitsForPlayer5 takes nothing returns nothing
    ...
    set gg_unit_Ekgg_0007 = CreateUnit( p, 'Ekgg', -1938.1, 2042.5, 175.600 )
endfunction
...
function CreateUnitsForPlayer6 takes nothing returns nothing
    ...
    set gg_unit_Etyr_0003 = CreateUnit( p, 'Etyr', -2620.6, 2040.9, 15.750 )
endfunction
...
function CreateUnitsForPlayer7 takes nothing returns nothing
    ...
    set gg_unit_edtm_0009 = CreateUnit( p, 'edtm', -672.7, 2533.3, 64.660 )
endfunction
...
function CreateUnitsForPlayer12 takes nothing returns nothing
    ...
    set gg_unit_edry_0005 = CreateUnit( p, 'edry', -2509.4, 1751.2, 73.540 )
endfunction
...
function CreateBuildingsForPlayer13 takes nothing returns nothing
    ...
    set u = CreateUnit( p, 'ncaw', -534.2, 2317.2, -68.524 )
...
function CreateUnitsForPlayer14 takes nothing returns nothing
    ...
    set gg_unit_ewsp_0008 = CreateUnit( p, 'ewsp', -1266.8, 509.7, 204.620 )
endfunction
...
function CreateUnitsForPlayer20 takes nothing returns nothing
    ...
    set gg_unit_eshd_0000 = CreateUnit( p, 'eshd', -2001.8, 1882.5, 247.520 )
endfunction
...
// Trigger: PICNIC
//===========================================================================
function Trig_PICNIC_Actions takes nothing returns nothing
    call SetDoodadAnimationRectBJ( "death", 'YOtf', GetPlayableMapRect() )
    call SetDoodadAnimationRectBJ( "death", 'YOf2', GetPlayableMapRect() )
    call SetDoodadAnimationRectBJ( "death", 'YOfs', GetPlayableMapRect() )
    call SetTimeOfDay( 4.00 )
    call SetDoodadAnimationRectBJ( "death", 'YOfb', GetPlayableMapRect() )
    call SetDoodadAnimationRectBJ( "death", 'YOlb', GetPlayableMapRect() )
    call SetDoodadAnimationRectBJ( "decay", 'NOfp', GetPlayableMapRect() )
    call PanCameraToTimedLocForPlayer( Player(0), GetRectCenter(gg_rct_Region_000), 0 )
    call CameraSetupApplyForPlayer( true, gg_cam_Camera_001, Player(0), 3.00 )
    call CinematicModeBJ( true, GetPlayersAll() )
    call ShowInterfaceForceOff( GetPlayersAll(), 2 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_001", gg_snd_MuradinYes2, "TRIGSTR_002", bj_TIMETYPE_ADD, 0, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_013", gg_snd_FurionWhat4, "TRIGSTR_014", bj_TIMETYPE_ADD, 0, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_015", gg_snd_KeeperOfTheGroveYes5, "TRIGSTR_016", bj_TIMETYPE_ADD, 0, true )
    call TriggerSleepAction( 5.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_017", gg_snd_IllidanWhat2, "TRIGSTR_018", bj_TIMETYPE_ADD, 0, true )
    call TriggerSleepAction( 2 )
    call SetDoodadAnimationRectBJ( "stand", 'YOlb', GetPlayableMapRect() )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_019", gg_snd_KeeperOfTheGroveYes3, "TRIGSTR_020", bj_TIMETYPE_ADD, 0, true )
    call SetDoodadAnimationRectBJ( "stand", 'YOfb', GetPlayableMapRect() )
    call TriggerSleepAction( 1.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_021", gg_snd_HeroDemonHunterYes4, "TRIGSTR_022", bj_TIMETYPE_ADD, 0, true )
    call TriggerSleepAction( 0.70 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Ekgg_0007, "TRIGSTR_023", gg_snd_IllidanPissed1, "TRIGSTR_024", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_025", gg_snd_IllidanPissed3, "TRIGSTR_026", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_nwat_0002, "TRIGSTR_027", gg_snd_ArcherPissed6, "TRIGSTR_028", bj_TIMETYPE_ADD, 1.00, true )
    call TriggerSleepAction( 2 )
    call IssuePointOrderLocBJ( gg_unit_Eill_0004, "move", GetRectCenter(gg_rct_Region_001) )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_029", gg_snd_VillagerMAWhat4, "TRIGSTR_030", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_eshd_0000, "TRIGSTR_031", gg_snd_ShandrisPissed2, "TRIGSTR_032", bj_TIMETYPE_ADD, 1.00, true )
    call IssuePointOrderLocBJ( gg_unit_Eill_0004, "move", GetRectCenter(gg_rct_Region_002) )
    call TriggerSleepAction( 3.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_033", gg_snd_VillagerMAWhat6, "TRIGSTR_034", bj_TIMETYPE_ADD, 0.50, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_edry_0005, "TRIGSTR_035", gg_snd_DryadPissed1, "TRIGSTR_036", bj_TIMETYPE_ADD, 0.50, true )
    call IssuePointOrderLocBJ( gg_unit_Eill_0004, "move", GetRectCenter(gg_rct_Region_003) )
    call TriggerSleepAction( 2.00 )
    call SetUnitFacingToFaceLocTimed( gg_unit_Eill_0004, GetRectCenter(gg_rct_Region_000), 2.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Ekgg_0007, "TRIGSTR_037", gg_snd_O04Mannoroth38, "TRIGSTR_038", bj_TIMETYPE_ADD, 0.50, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_039", gg_snd_U04AArthas09, "TRIGSTR_040", bj_TIMETYPE_ADD, 0.50, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Ekgg_0007, "TRIGSTR_041", gg_snd_HeroPaladinWhat2, "TRIGSTR_042", bj_TIMETYPE_ADD, 0.50, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_049", gg_snd_IllidanPissed5, "TRIGSTR_050", bj_TIMETYPE_ADD, 0.50, true )
    call IssueImmediateOrderBJ( gg_unit_Eill_0004, "metamorphosis" )
    call TriggerSleepAction( 1.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Ekgg_0007, "TRIGSTR_043", gg_snd_MortarTeamWhat1, "TRIGSTR_044", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_045", gg_snd_HeroBladeMasterYes4, "TRIGSTR_046", bj_TIMETYPE_ADD, 1.00, true )
    call IssueTargetOrderBJ( gg_unit_Eill_0004, "attack", gg_unit_Ekgg_0007 )
    call IssueTargetOrderBJ( gg_unit_Ekgg_0007, "attack", gg_unit_Eill_0004 )
    call TriggerSleepAction( 8.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Etyr_0003, "TRIGSTR_047", gg_snd_HeroMoonPriestessWhat2, "TRIGSTR_048", bj_TIMETYPE_ADD, 0, true )
    call IssueTargetOrderBJ( gg_unit_eshd_0000, "attack", gg_unit_Ekgg_0007 )
    call TriggerSleepAction( 8.00 )
    call KillUnit( gg_unit_Ekgg_0007 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_eshd_0000, "TRIGSTR_051", gg_snd_ShandrisPissed3, "TRIGSTR_052", bj_TIMETYPE_ADD, 0, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Etyr_0003, "TRIGSTR_053", gg_snd_ShandrisPissed4, "TRIGSTR_054", bj_TIMETYPE_ADD, 0, true )
    call TriggerSleepAction( 1.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_055", gg_snd_HeroDemonHunterPissed7, "TRIGSTR_056", bj_TIMETYPE_ADD, 0, true )
    call TriggerSleepAction( 1.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_057", gg_snd_IllidanPissed401, "TRIGSTR_058", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_059", gg_snd_FurionYesAttack2, "TRIGSTR_060", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_063", gg_snd_IllidanYes1, "TRIGSTR_064", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_065", gg_snd_DryadPissed2, "TRIGSTR_066", bj_TIMETYPE_ADD, 1.00, true )
    call IssuePointOrderLocBJ( gg_unit_Efur_0001, "move", GetRectCenter(gg_rct_Region_004) )
    call TriggerSleepAction( 2 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_071", gg_snd_KeeperOfTheGrovePissed5, "TRIGSTR_072", bj_TIMETYPE_ADD, 1.00, true )
    call IssuePointOrderLocBJ( gg_unit_eshd_0000, "move", GetRectCenter(gg_rct_Region_005) )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_eshd_0000, "TRIGSTR_067", gg_snd_ShandrisYes1, "TRIGSTR_068", bj_TIMETYPE_ADD, 0, true )
    call IssuePointOrderLocBJ( gg_unit_edry_0005, "move", GetRectCenter(gg_rct_Region_002) )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_edry_0005, "TRIGSTR_069", gg_snd_DryadWhat1, "TRIGSTR_070", bj_TIMETYPE_ADD, 0, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_eshd_0000, "TRIGSTR_073", gg_snd_ShandrisYesAttack2, "TRIGSTR_074", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_edry_0005, "TRIGSTR_075", gg_snd_DryadYesAttack2, "TRIGSTR_076", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_eshd_0000, "TRIGSTR_077", gg_snd_ArcherYesAttack1, "TRIGSTR_078", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_nwat_0002, "TRIGSTR_079", gg_snd_JainaYes3, "TRIGSTR_080", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_eshd_0000, "TRIGSTR_081", gg_snd_ArcherPissed7, "TRIGSTR_082", bj_TIMETYPE_ADD, 1.00, true )
    call IssueTargetOrderBJ( gg_unit_eshd_0000, "attackonce", gg_unit_edry_0005 )
    call TriggerSleepAction( 1.00 )
    call ExplodeUnitBJ( gg_unit_edry_0005 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_eshd_0000, "TRIGSTR_083", gg_snd_WarlordYesAttack5, "TRIGSTR_084", bj_TIMETYPE_ADD, 1.00, true )
    call PlaySoundBJ( gg_snd_P2 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_085", null, "TRIGSTR_086", bj_TIMETYPE_ADD, 1.00, true )
    call SetUnitColor( gg_unit_ewsp_0008, PLAYER_COLOR_LIGHT_GRAY )
    call IssuePointOrderLocBJ( gg_unit_Efur_0001, "move", GetRectCenter(gg_rct_Region_006) )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_087", gg_snd_FurionWhat1, "TRIGSTR_088", bj_TIMETYPE_ADD, 1.00, true )
    call TriggerSleepAction( 1.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_089", gg_snd_HeroDreadlordPissed5, "TRIGSTR_090", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_091", gg_snd_DeathKnightWhat1, "TRIGSTR_092", bj_TIMETYPE_ADD, 1.00, true )
    call PlaySoundBJ( gg_snd_1Nevermind )
    call IssuePointOrderLocBJ( gg_unit_edtm_0009, "move", GetRectCenter(gg_rct_Region_007) )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_ewsp_0008, "TRIGSTR_093", null, "TRIGSTR_094", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_edtm_0009, "TRIGSTR_095", gg_snd_VultureWhat1, "TRIGSTR_096", bj_TIMETYPE_ADD, 0, true )
    call IssueImmediateOrderBJ( gg_unit_edtm_0009, "unravenform" )
    call SetUnitAnimation( gg_unit_edtm_0009, "stand" )
    call TransmissionFromUnitTypeWithNameBJ( GetPlayersAll(), Player(0), 'edot', "TRIGSTR_097", GetRectCenter(GetPlayableMapRect()), gg_snd_GoblinMerchantWhat1, "TRIGSTR_098", bj_TIMETYPE_ADD, 0, true )
    call TransmissionFromUnitTypeWithNameBJ( GetPlayersAll(), Player(0), 'edot', "TRIGSTR_099", GetRectCenter(GetPlayableMapRect()), gg_snd_TyrandeWhat4, "TRIGSTR_100", bj_TIMETYPE_ADD, 1.00, true )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_103", gg_snd_HeroArchMageWhat4, "TRIGSTR_104", bj_TIMETYPE_ADD, 0, true )
    call IssueTargetOrderBJ( gg_unit_Efur_0001, "entanglingroots", gg_unit_edtm_0009 )
    call TriggerSleepAction( 2 )
    call KillUnit( gg_unit_edtm_0009 )
    call IssuePointOrderLocBJ( gg_unit_Eill_0004, "move", GetRectCenter(gg_rct_Region_009) )
    call CameraSetupApplyForPlayer( true, gg_cam_Camera_003, Player(0), 3.00 )
    call IssuePointOrderLocBJ( gg_unit_Efur_0001, "move", GetRectCenter(gg_rct_Region_008) )
    call TriggerSleepAction( 3.50 )
    call IssueImmediateOrderBJ( gg_unit_Efur_0001, "tranquility" )
    call TriggerSleepAction( 5.00 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Efur_0001, "TRIGSTR_107", gg_snd_OgreWhat1, "TRIGSTR_108", bj_TIMETYPE_ADD, 0, true )
    call DisableTrigger( gg_trg_Toilet_flush )
    call CameraSetupApplyForPlayer( true, gg_cam_Camera_002, Player(0), 2.00 )
    call TriggerSleepAction( 3.00 )
    call SetUnitManaPercentBJ( gg_unit_emow_0010, 100 )
    call IssuePointOrderLocBJ( gg_unit_Efur_0001, "move", GetRectCenter(gg_rct_Region_006) )
    call TriggerSleepAction( 3.00 )
    call CameraSetupApplyForPlayer( true, gg_cam_Camera_001, Player(0), 3.00 )
    call PlaySoundBJ( gg_snd_WolfriderPissed3 )
    call TransmissionFromUnitWithNameBJ( GetPlayersAll(), gg_unit_Eill_0004, "TRIGSTR_105", null, "TRIGSTR_106", bj_TIMETYPE_ADD, 0, false )
    call TriggerSleepAction( 1.20 )
    call StopSoundBJ( gg_snd_WolfriderPissed3, false )
    ...
    call SetDoodadAnimationRectBJ( "stand", 'YOfs', GetPlayableMapRect() )
    call PlaySoundBJ( gg_snd_BuildingDeathSmallHuman )
    call KillUnit( gg_unit_Etyr_0003 )
    call KillUnit( gg_unit_edry_0005 )
    call ExplodeUnitBJ( gg_unit_eshd_0000 )
    call ExplodeUnitBJ( gg_unit_nwat_0002 )
    call ExplodeUnitBJ( gg_unit_emow_0010 )
    call ExplodeUnitBJ( gg_unit_Efur_0001 )
    call ExplodeUnitBJ( gg_unit_Eill_0004 )
    call CinematicFadeBJ( bj_CINEFADETYPE_FADEIN, 2, "ReplaceableTextures\\CameraMasks\\White_mask.blp", 0, 0, 0, 0 )
    call TriggerSleepAction( 1.00 )
    call PlaySoundBJ( gg_snd_HarpyYes1 )
    call TriggerSleepAction( 2.00 )
    call DisplayTimedTextToForce( GetPlayersAll(), 80.00, "TRIGSTR_109" )
    call TriggerSleepAction( 3.00 )
    call TransmissionFromUnitTypeWithNameBJ( GetPlayersAll(), Player(0), 'uabo', "TRIGSTR_110", GetRectCenter(GetPlayableMapRect()), gg_snd_WarlockAppears, "TRIGSTR_111", bj_TIMETYPE_ADD, 2.00, true )
    call CustomVictoryBJ( Player(0), true, false )
endfunction

//===========================================================================
function InitTrig_PICNIC takes nothing returns nothing
    set gg_trg_PICNIC = CreateTrigger(  )
    call TriggerRegisterTimerEventSingle( gg_trg_PICNIC, 0.00 )
    call TriggerAddAction( gg_trg_PICNIC, function Trig_PICNIC_Actions )
endfunction

//===========================================================================
// Trigger: Toilet flush
//
// Toilet is the moon well.
// I did'nt wanted to fill it, because it's like toilet.
//===========================================================================
function Trig_Toilet_flush_Actions takes nothing returns nothing
    call SetUnitManaBJ( gg_unit_emow_0010, 0 )
endfunction

//===========================================================================
function InitTrig_Toilet_flush takes nothing returns nothing
    set gg_trg_Toilet_flush = CreateTrigger(  )
    call TriggerRegisterTimerEventPeriodic( gg_trg_Toilet_flush, 1.00 )
    call TriggerAddAction( gg_trg_Toilet_flush, function Trig_Toilet_flush_Actions )
endfunction

//===========================================================================
function InitCustomTriggers takes nothing returns nothing
    call InitTrig_PICNIC(  )
    call InitTrig_Toilet_flush(  )
endfunction
